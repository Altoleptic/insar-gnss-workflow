...
def process_stations():
    ...
    if "los_east" not in parameters_df.columns or "los_north" not in parameters_df.columns or "los_up" not in parameters_df.columns:
        print("Error: Parameters file does not contain required LOS components.")
        return
